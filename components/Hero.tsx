  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-moss-deep/95 via-moss-deep/65 to-moss-deep/20" />
        <div className="absolute inset-0 bg-gradient-to-r from-moss-deep/55 via-transparent to-transparent" />
      </div>
